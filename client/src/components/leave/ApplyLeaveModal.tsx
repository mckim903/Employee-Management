    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm" onClick={onClose}>
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg animate-fade-in" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="">
                ...
                <input type="date" name="startDate" required min={minDate} className="" />
              </div>
              <div className="">
                <span className="block text-xs text-slate-400 mb-1">To</span>
                <input type="date" name="endDate" required min={minDate} className="" />
              </div>
            </div>
          </div>
          ...
          <textarea name="reason" rows={3} required className="resize-none" placeholder="Briefly describe why you need this leave..." />
