...
export const updateEmployee = async (req, res) => {
    try {
        const {id} = req.params
        const {firstName, lastName, email, password, phone, position, department, basicSalary, allowances, deductions, joinDate, role, bio, employmentStatus} = req.body
